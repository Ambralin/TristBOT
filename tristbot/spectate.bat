...
:start
@start "" "League of Legends.exe" "spectator spectator.eu.lol.riotgames.com:80 3HFP8zfwsd5f/IUadzh7ikCioOBpHzfj 3049943573 EUN1" -UseRads -GameBaseDir=.. "-Locale=%locale%" -SkipBuild -EnableCrashpad=true -EnableLNP
goto exit
