...
:start
@start "" "League of Legends.exe" "spectator spectator.euw1.lol.riotgames.com:80 mg/yW3fhOr0xi3Y7JZ+tiIP5UmaRTS+u 6643518285 EUW1" -UseRads -GameBaseDir=.. "-Locale=%locale%" -SkipBuild -EnableCrashpad=true -EnableLNP
goto exit
